...
| C18 | Cross-venue actions | Copying a feed post or event across venues requires the actor to be authorised **in both** the source and destination venue, and both venues must belong to the same business. |
