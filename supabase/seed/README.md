...
`supabase/config.toml` points `[db.seed].sql_paths` at `./seed/01_foundation.sql`, `./seed/02_staff_presence.sql`, `./seed/03_events.sql`, `./seed/04_atmosphere.sql`, then `./seed/05_feed.sql`.
